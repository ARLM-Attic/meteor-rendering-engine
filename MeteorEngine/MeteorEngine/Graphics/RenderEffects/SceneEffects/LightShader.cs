...
namespace Meteor.Rendering
{
    class LightShader : BaseRenderer
    {
		...
		{
			// Draw world space position			
			GraphicsDevice.BlendState = BlendState.Opaque;
			GraphicsDevice.SetRenderTarget(positionRT);
			GraphicsDevice.Clear(Color.Transparent);
			...
			directionalLightEffect.CurrentTechnique = directionalLightEffect.Techniques["CalculatePosition"];
			EffectPass pass = directionalLightEffect.CurrentTechnique.Passes[0];
			...
			// Set common parameters for shadows
			...
			directionalLightEffect.Parameters["positionMap"].SetValue(positionRT);
			...
			foreach (DirectionLight light in scene.directionalLights)
			{
				if (light.castsShadows)
				{
					...
					pass = directionalLightEffect.CurrentTechnique.Passes[0];
